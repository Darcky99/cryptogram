...
public class FindMaterialsInUse : EditorWindow
{
    ...
    {
        EditorWindow.GetWindow(typeof(FindMaterialsInUse));
    }
    ...
    void OnGUI()
    {
        ...
        EditorGUILayout.HelpBox("\n1. Select a material in the 'Material to find' Input field.\n2. Then press the 'Find' Button.\n3. After some calculations it will list the objects below. \n\n(This could take some time, depending on your Hardware and the amount of objects and Materials in your project.\n", MessageType.Info);
